...
NTSTATUS
TemperUsbDriverQueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = TemperUsbDriverEvtIoDeviceControl;
    queueConfig.EvtIoStop = TemperUsbDriverEvtIoStop;
...
VOID
TemperUsbDriverEvtIoDeviceControl(
    _In_ WDFQUEUE Queue,
